...
# for (HER_h_ in HER_[1:1]){
for (HER_h_ in HER_){
# for (HER_h_ in HER_[(length(HER_)-5):length(HER_)]){
  ...
  # Save
  svg_device <- svglite(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",HER_h_,"_sansEt_1_20240305.svg"),
                        width = 18)
  print(p)
  dev.off()
  
  saveRDS(p, file = paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",HER_h_,"_sansEt_1_20240305.rds"))
