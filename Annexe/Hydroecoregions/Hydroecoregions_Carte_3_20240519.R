...
# Save
svg_device <- svglite(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapGenerale/MapHER_sansEt_1_20240519.svg"),
                      width = 18)
print(p)
dev.off()

saveRDS(p, file = paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapGenerale/MapHER_sansEt_1_20240519.rds"))

# x11()
ggsave(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapGenerale/MapHER_sansEt_1_20240519.png"),
       plot = p)
