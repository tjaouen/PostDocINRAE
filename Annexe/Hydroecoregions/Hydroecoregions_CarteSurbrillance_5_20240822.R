...
# Save
svg_device <- svglite(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240822.svg"),
                      width = 18)
print(p)
dev.off()

saveRDS(p, file = paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240822.rds"))

# x11()
ggsave(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240822.png"),
       plot = p)
