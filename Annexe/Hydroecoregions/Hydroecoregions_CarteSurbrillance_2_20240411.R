...
p <- ggplot() +
  geom_polygon(data=fr.frontieres, aes(x=long, y=lat, group=group), fill = "white",
               color="grey38", linewidth = 1) +
  scale_fill_manual(values=c("#ffffff"),
                    breaks=c("#ffffff"),
                    drop = F)
p <- ggplot() +
  geom_polygon(data=fr.df_HER_, aes(x=long, y=lat, group=group, fill=var_cut_), linewidth = 0)+ # color = "black", linewidth = 0.3
...
# Save
svg_device <- svglite(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240411.svg"),
                      width = 18)
print(p)
dev.off()

saveRDS(p, file = paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240411.rds"))

# x11()
ggsave(paste0("/home/tjaouen/Documents/Input/HER/HER2hybrides/MapsIndividuelles/MapHER_",paste(HER_h_, collapse = "_"),"_sansEt_1_20240411.png"),
       plot = p)
