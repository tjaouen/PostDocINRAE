...
### Function ###
plot_map_variable <- function(tab_, varname_, vartitle_, breaks_, output_name_, title_, reverseColors_, nomPalette_, labels_name_ = FALSE, reverseLegend_ = FALSE, echelleAttenuee_ = FALSE, addValueUnder = NULL, HER2_excluesDensity_ = NULL, subtitle_ = NULL, annotation_txt_ = TRUE, percentFormat = T, borderCol = "#454547"){
  ...
  if (is.Date(tab_$MedianDay_FirstP10_Value)){
  ...
  if (annotation_txt_){
    ...
    svg_device <- svglite(paste0(output_name_,"_sansTxt.svg"))#,
  }
...
### Function ###
plot_map_variable_sansEtiquettes <- function(tab_, varname_, vartitle_, breaks_, output_name_, title_, reverseColors_, nomPalette_, labels_name_ = FALSE, sansTexteHer_ = FALSE, reverseLegend_ = FALSE, echelleAttenuee_ = FALSE, addValueUnder = NULL, HER2_excluesDensity_ = NULL, subtitle_ = NULL, annotation_txt_ = TRUE, percentFormat = T, borderCol = "#454547"){
  ...
  if (annotation_txt_){
    ...
    svg_device <- svglite(paste0(output_name_,"_sansTxt_sansEt.svg"))#,
    print(p)
    dev.off()
  }
  # width = 18)
