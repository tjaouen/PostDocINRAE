...
### Run ###
chro_ = read.table(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Input/HYDRO/EtudeFrance/Tab_ChroniquesProbaParHER2_LearnBrut_ByHer/FDC_Projections/",model_,"_20231128/ChroniquesCombinees_saf_hist_rcp85/Tab_ChroniquesProba_LearnBrut_HER",HER_h_,".txt"),
                   sep = ";", dec = ".", header = T)
...
chro_$Mediane <- apply(chro_[, grepl("debit_France", colnames(chro_))], 1, median)
