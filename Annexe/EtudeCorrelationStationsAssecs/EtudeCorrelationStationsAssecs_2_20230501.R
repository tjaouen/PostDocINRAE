...
write.table(cor_, "/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/3_ChroniquesAssecs_ParHer/1_PresentMesures_HERh_TsKGE_TtesStat_2012_2022_20230417/Correlations/CorrelationEtLogitStationsAssecs_2_20230501.csv", sep = ";", dec = ".", row.names = F)
...
write.table(cor_merge_[rev(order(cor_merge_$Cor)),], "/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/3_ChroniquesAssecs_ParHer/1_PresentMesures_HERh_TsKGE_TtesStat_2012_2022_20230417/Correlations/CorrelationEtLogitStationsAssecs_DescriptifStations_2_20230502.csv", sep = ";", dec = ".", row.names = F)
...
x11()
ggplot(tab_merge_, aes(x = flow_O153291001_HYDRO_QJM.txt, y = X._Assec/100, color = as.factor(format(as.Date(Date, format = "%Y-%m-%d"), "%Y")))) +
  geom_point(size = 3) +
