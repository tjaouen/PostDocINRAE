...
makeBlocTable_initDate_ <- function(HER_){
  ...
  vect_ <- c(
    ...
    ### H0 57 ###
    format(as.Date(min(CTRIP_H0_$initDate_min_[which(CTRIP_H0_$HER == HER_)],
                       GRSD_H0_$initDate_min_[which(GRSD_H0_$HER == HER_)],
                       ORCHIDEE_H0_$initDate_min_[which(ORCHIDEE_H0_$HER == HER_)],
                       SMASH_H0_$initDate_min_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H0_$initDate_median_[which(CTRIP_H0_$HER == HER_)],
                              GRSD_H0_$initDate_median_[which(GRSD_H0_$HER == HER_)],
                              ORCHIDEE_H0_$initDate_median_[which(ORCHIDEE_H0_$HER == HER_)],
                              SMASH_H0_$initDate_median_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H0_$initDate_median_[which(CTRIP_H0_$HER == HER_)],
                              GRSD_H0_$initDate_median_[which(GRSD_H0_$HER == HER_)],
                              ORCHIDEE_H0_$initDate_median_[which(ORCHIDEE_H0_$HER == HER_)],
                              SMASH_H0_$initDate_median_[which(SMASH_H0_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H0_$initDate_max_[which(CTRIP_H0_$HER == HER_)],
                       GRSD_H0_$initDate_max_[which(GRSD_H0_$HER == HER_)],
                       ORCHIDEE_H0_$initDate_max_[which(ORCHIDEE_H0_$HER == HER_)],
                       SMASH_H0_$initDate_max_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
    
    ### H2 57 ###
    format(as.Date(min(CTRIP_H2_$initDate_min_[which(CTRIP_H2_$HER == HER_)],
                       GRSD_H2_$initDate_min_[which(GRSD_H2_$HER == HER_)],
                       ORCHIDEE_H2_$initDate_min_[which(ORCHIDEE_H2_$HER == HER_)],
                       SMASH_H2_$initDate_min_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H2_$initDate_median_[which(CTRIP_H2_$HER == HER_)],
                              GRSD_H2_$initDate_median_[which(GRSD_H2_$HER == HER_)],
                              ORCHIDEE_H2_$initDate_median_[which(ORCHIDEE_H2_$HER == HER_)],
                              SMASH_H2_$initDate_median_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H2_$initDate_median_[which(CTRIP_H2_$HER == HER_)],
                              GRSD_H2_$initDate_median_[which(GRSD_H2_$HER == HER_)],
                              ORCHIDEE_H2_$initDate_median_[which(ORCHIDEE_H2_$HER == HER_)],
                              SMASH_H2_$initDate_median_[which(SMASH_H2_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H2_$initDate_max_[which(CTRIP_H2_$HER == HER_)],
                       GRSD_H2_$initDate_max_[which(GRSD_H2_$HER == HER_)],
                       ORCHIDEE_H2_$initDate_max_[which(ORCHIDEE_H2_$HER == HER_)],
                       SMASH_H2_$initDate_max_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
    
    ### H3 57 ###
    format(as.Date(min(CTRIP_H3_$initDate_min_[which(CTRIP_H3_$HER == HER_)],
                       GRSD_H3_$initDate_min_[which(GRSD_H3_$HER == HER_)],
                       ORCHIDEE_H3_$initDate_min_[which(ORCHIDEE_H3_$HER == HER_)],
                       SMASH_H3_$initDate_min_[which(SMASH_H3_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H3_$initDate_median_[which(CTRIP_H3_$HER == HER_)],
                              GRSD_H3_$initDate_median_[which(GRSD_H3_$HER == HER_)],
                              ORCHIDEE_H3_$initDate_median_[which(ORCHIDEE_H3_$HER == HER_)],
                              SMASH_H3_$initDate_median_[which(SMASH_H3_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H3_$initDate_median_[which(CTRIP_H3_$HER == HER_)],
                              GRSD_H3_$initDate_median_[which(GRSD_H3_$HER == HER_)],
                              ORCHIDEE_H3_$initDate_median_[which(ORCHIDEE_H3_$HER == HER_)],
                              SMASH_H3_$initDate_median_[which(SMASH_H3_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H3_$initDate_max_[which(CTRIP_H3_$HER == HER_)],
                       GRSD_H3_$initDate_max_[which(GRSD_H3_$HER == HER_)],
                       ORCHIDEE_H3_$initDate_max_[which(ORCHIDEE_H3_$HER == HER_)],
                       SMASH_H3_$initDate_max_[which(SMASH_H3_$HER == HER_)])),"%d/%m"))
...
makeBlocTable_finishDate_ <- function(HER_){
  ...
  vect_ <- c(
    ...
    ### H0 57 ###
    format(as.Date(min(CTRIP_H0_$finishDate_min_[which(CTRIP_H0_$HER == HER_)],
                       GRSD_H0_$finishDate_min_[which(GRSD_H0_$HER == HER_)],
                       ORCHIDEE_H0_$finishDate_min_[which(ORCHIDEE_H0_$HER == HER_)],
                       SMASH_H0_$finishDate_min_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H0_$finishDate_median_[which(CTRIP_H0_$HER == HER_)],
                              GRSD_H0_$finishDate_median_[which(GRSD_H0_$HER == HER_)],
                              ORCHIDEE_H0_$finishDate_median_[which(ORCHIDEE_H0_$HER == HER_)],
                              SMASH_H0_$finishDate_median_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H0_$finishDate_median_[which(CTRIP_H0_$HER == HER_)],
                              GRSD_H0_$finishDate_median_[which(GRSD_H0_$HER == HER_)],
                              ORCHIDEE_H0_$finishDate_median_[which(ORCHIDEE_H0_$HER == HER_)],
                              SMASH_H0_$finishDate_median_[which(SMASH_H0_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H0_$finishDate_max_[which(CTRIP_H0_$HER == HER_)],
                       GRSD_H0_$finishDate_max_[which(GRSD_H0_$HER == HER_)],
                       ORCHIDEE_H0_$finishDate_max_[which(ORCHIDEE_H0_$HER == HER_)],
                       SMASH_H0_$finishDate_max_[which(SMASH_H0_$HER == HER_)])),"%d/%m"),
    
    ### H2 57 ###
    format(as.Date(min(CTRIP_H2_$finishDate_min_[which(CTRIP_H2_$HER == HER_)],
                       GRSD_H2_$finishDate_min_[which(GRSD_H2_$HER == HER_)],
                       ORCHIDEE_H2_$finishDate_min_[which(ORCHIDEE_H2_$HER == HER_)],
                       SMASH_H2_$finishDate_min_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H2_$finishDate_median_[which(CTRIP_H2_$HER == HER_)],
                              GRSD_H2_$finishDate_median_[which(GRSD_H2_$HER == HER_)],
                              ORCHIDEE_H2_$finishDate_median_[which(ORCHIDEE_H2_$HER == HER_)],
                              SMASH_H2_$finishDate_median_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H2_$finishDate_median_[which(CTRIP_H2_$HER == HER_)],
                              GRSD_H2_$finishDate_median_[which(GRSD_H2_$HER == HER_)],
                              ORCHIDEE_H2_$finishDate_median_[which(ORCHIDEE_H2_$HER == HER_)],
                              SMASH_H2_$finishDate_median_[which(SMASH_H2_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H2_$finishDate_max_[which(CTRIP_H2_$HER == HER_)],
                       GRSD_H2_$finishDate_max_[which(GRSD_H2_$HER == HER_)],
                       ORCHIDEE_H2_$finishDate_max_[which(ORCHIDEE_H2_$HER == HER_)],
                       SMASH_H2_$finishDate_max_[which(SMASH_H2_$HER == HER_)])),"%d/%m"),
    
    ### H3 57 ###
    format(as.Date(min(CTRIP_H3_$finishDate_min_[which(CTRIP_H3_$HER == HER_)],
                       GRSD_H3_$finishDate_min_[which(GRSD_H3_$HER == HER_)],
                       ORCHIDEE_H3_$finishDate_min_[which(ORCHIDEE_H3_$HER == HER_)],
                       SMASH_H3_$finishDate_min_[which(SMASH_H3_$HER == HER_)])),"%d/%m"),
    
    paste0(format(as.Date(min(CTRIP_H3_$finishDate_median_[which(CTRIP_H3_$HER == HER_)],
                              GRSD_H3_$finishDate_median_[which(GRSD_H3_$HER == HER_)],
                              ORCHIDEE_H3_$finishDate_median_[which(ORCHIDEE_H3_$HER == HER_)],
                              SMASH_H3_$finishDate_median_[which(SMASH_H3_$HER == HER_)])),"%d/%m"),
           "-",
           format(as.Date(max(CTRIP_H3_$finishDate_median_[which(CTRIP_H3_$HER == HER_)],
                              GRSD_H3_$finishDate_median_[which(GRSD_H3_$HER == HER_)],
                              ORCHIDEE_H3_$finishDate_median_[which(ORCHIDEE_H3_$HER == HER_)],
                              SMASH_H3_$finishDate_median_[which(SMASH_H3_$HER == HER_)])),"%d/%m")),
    
    format(as.Date(max(CTRIP_H3_$finishDate_max_[which(CTRIP_H3_$HER == HER_)],
                       GRSD_H3_$finishDate_max_[which(GRSD_H3_$HER == HER_)],
                       ORCHIDEE_H3_$finishDate_max_[which(ORCHIDEE_H3_$HER == HER_)],
                       SMASH_H3_$finishDate_max_[which(SMASH_H3_$HER == HER_)])),"%d/%m"))
...
makeBlocTable_ProbaMean_ <- function(HER_){
  ...
  vect_ <- c(
    ...
    paste0(min(CTRIP_H0_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H0_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H0_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H0_$HER == HER_)],
               GRSD_H0_$propAssecMoyenneJuilletOct_ModeleMedian_[which(GRSD_H0_$HER == HER_)],
               ORCHIDEE_H0_$propAssecMoyenneJuilletOct_ModeleMedian_[which(ORCHIDEE_H0_$HER == HER_)],
               SMASH_H0_$propAssecMoyenneJuilletOct_ModeleMedian_[which(SMASH_H0_$HER == HER_)])),
    ...
    paste0(min(CTRIP_H2_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H2_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H2_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H2_$HER == HER_)],
               GRSD_H2_$propAssecMoyenneJuilletOct_ModeleMedian_[which(GRSD_H2_$HER == HER_)],
               ORCHIDEE_H2_$propAssecMoyenneJuilletOct_ModeleMedian_[which(ORCHIDEE_H2_$HER == HER_)],
               SMASH_H2_$propAssecMoyenneJuilletOct_ModeleMedian_[which(SMASH_H2_$HER == HER_)])),
    ...
    paste0(min(CTRIP_H3_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H3_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H3_$propAssecMoyenneJuilletOct_ModeleMedian_[which(CTRIP_H3_$HER == HER_)],
               GRSD_H3_$propAssecMoyenneJuilletOct_ModeleMedian_[which(GRSD_H3_$HER == HER_)],
               ORCHIDEE_H3_$propAssecMoyenneJuilletOct_ModeleMedian_[which(ORCHIDEE_H3_$HER == HER_)],
               SMASH_H3_$propAssecMoyenneJuilletOct_ModeleMedian_[which(SMASH_H3_$HER == HER_)])),
...
makeBlocTable_NbJoursSup20_ <- function(HER_){
  ...
  vect_ <- c(
    ...
    paste0(min(CTRIP_H0_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H0_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H0_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H0_$HER == HER_)],
               GRSD_H0_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(GRSD_H0_$HER == HER_)],
               ORCHIDEE_H0_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(ORCHIDEE_H0_$HER == HER_)],
               SMASH_H0_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(SMASH_H0_$HER == HER_)])),
    ...
    paste0(min(CTRIP_H2_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H2_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H2_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H2_$HER == HER_)],
               GRSD_H2_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(GRSD_H2_$HER == HER_)],
               ORCHIDEE_H2_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(ORCHIDEE_H2_$HER == HER_)],
               SMASH_H2_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(SMASH_H2_$HER == HER_)])),
    ...
    paste0(min(CTRIP_H3_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H3_$HER == HER_)],
           ...
           "-",
           max(CTRIP_H3_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(CTRIP_H3_$HER == HER_)],
               GRSD_H3_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(GRSD_H3_$HER == HER_)],
               ORCHIDEE_H3_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(ORCHIDEE_H3_$HER == HER_)],
               SMASH_H3_$nbMoyenJoursParAnSup20pct_ModeleMedian_[which(SMASH_H3_$HER == HER_)])),
...
write.table(rbind(tab_57_,
                  ...
                  tab_13_,
                  tab_105_),
            "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/StatistiquesPFI_TableDateInit_1_20240610.csv",
            sep = ";", dec = ".", row.names = F)
...
write.table(rbind(tab_57_,
                  ...
                  tab_13_,
                  tab_105_),
            "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/StatistiquesPFI_TableDateFinish_1_20240610.csv",
            sep = ";", dec = ".", row.names = F)
...
write.table(rbind(tab_57_,
                  ...
                  tab_13_,
                  tab_105_),
            "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/StatistiquesPFI_TableProbaMean_1_20240610.csv",
            sep = ";", dec = ".", row.names = F)
...
write.table(rbind(tab_57_,
                  ...
                  tab_13_,
                  tab_105_),
            "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/StatistiquesPFI_TableNbJoursSup20_1_20240610.csv",
            sep = ";", dec = ".", row.names = F)
