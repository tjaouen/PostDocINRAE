...
# source("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/7_RunsEtudeFrance_DifferentsModelesHydro/1_Parameters/0_SimulationParameters_AvecCC_2_20230227_tmp.R")
source("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/7_RunsEtudeFrance_DifferentsModelesHydro/2_Run/7_Func_Relation_AvecCC_TestOndeManquantes_ExcludeOndeUsingFunction_11_20230607.R")
...
### Run ###
# liste <- c(list.files(paste0(folder_output_,"1_MatricesInputModeles_ParHERDates/21_ObservesReanalyseSafranJusqua2022_ProjectionsEnsuite/DebitsComp_ParModHydro_NetcdfMerged_From19760801_To21001231/"), pattern="MatInputModel", full.names = T))
...
### Choix simu ###
if (nom_GCM_ != ""){
  liste = liste[grepl(nom_GCM_,liste)]
}
...
for (il in liste) {
  ...
  regr = "logit"
  Assecs = FUNC_CAL_VAL(1, onde, liste_Her, regr, jourMin_ = jourMin_, jourMax_ = jourMax_)
