...
for(i in liste){
  ...
  debExtract = as.data.frame(cbind(Date = format(debExtract, "%Y%m%d"), FreqNonDep = 1-fdcurve, Debit = flow[, debit_variable_name_]))
