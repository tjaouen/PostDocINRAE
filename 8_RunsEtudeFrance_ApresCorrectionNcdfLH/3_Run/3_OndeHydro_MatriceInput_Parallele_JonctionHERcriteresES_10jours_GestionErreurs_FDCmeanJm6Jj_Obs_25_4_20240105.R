...
liste <- list.files(paste0(folder_input_PC_,
                           ...
                           nom_selectStations_,"/",
                           ifelse(nom_categorieSimu_=="","","TablesParModele_20231203/")),pattern="Stations_HYDRO", full.names = T)
    ...
    foreach(i = HER_, .combine = "rbind", .verbose = T) %dopar% { #, errorhandling='pass'
      ...
      tryCatch({
            ...
            for (date in 1:length(liste_mois)){
              ...
              if(length(Select_hydro) > 0 ){
                ...
                for (st in 1:length(Select_hydro)){
                  ...
                  if (dir.exists(paste0(folder_input_PC_,"FlowDurationCurves/",
                                        # presFut_param_,"/",
                    ...
                    if (file.exists(paste0(folder_input_PC_,"FlowDurationCurves/",
                                           # presFut_param_,"/",
                                           ifelse(obsSim_=="",nom_GCM_,
                                                  paste0("FDC_",obsSim_,
                                                         ifelse(nom_FDCfolder_param_=="","",paste0("_",nom_FDCfolder_param_)),"/",
                      ...
                      st_hydro = read.table(paste0(folder_input_PC_,"FlowDurationCurves/",
                                                   # presFut_param_,"/",
                                                   ifelse(obsSim_=="",nom_GCM_,
                                                          paste0("FDC_",obsSim_,
                                                                 ifelse(nom_FDCfolder_param_=="","",paste0("_",nom_FDCfolder_param_)),"/",
        ...
        if (!(dir.exists(paste0(folder_output_,
                                ...
                                ifelse(nom_GCM_=="","",paste0("/",nom_GCM_)))))){ dir.create(paste0(folder_output_,
                                                                                                    "1_MatricesInputModeles_ParHERDates/",
                                                                                                    nomSim_,
                                                                                                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
        ...
        if (!(dir.exists(paste0(folder_output_,
                                ...
                                ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                ifelse(nom_GCM_=="","",paste0("/",nom_GCM_)),
                                "/tmp/")))){ dir.create(paste0(folder_output_,
                                                               "1_MatricesInputModeles_ParHERDates/",
                                                               nomSim_,
                                                               ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                                               ifelse(nom_GCM_=="","",paste0("/",nom_GCM_)),
