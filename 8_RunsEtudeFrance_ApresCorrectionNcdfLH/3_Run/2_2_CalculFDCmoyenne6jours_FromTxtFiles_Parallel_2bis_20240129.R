...
liste_folders_ = liste_folders_[c(4,8)]
# liste_folders_ = liste_folders_[c(1:8)]
# liste_folders_ = liste_folders_[c(9:length(liste_folders_))]
...
output <- foreach(folder_ = liste_folders_) %dopar% { #, errorhandling='pass'
  ...
  # for (i in liste_fichiers_[1:329]){
  # for (i in liste_fichiers_[360:length(liste_fichiers_)]){
