...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       # "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
                       "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/Intercept_B")
# "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       # "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
                       "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/Intercept_BsE")
# "/TableGlobale/Map_English/1_Map_Globale_Intercept_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
tab_results_$ProbaAssecFDCnulle_boot = exp(tab_results_$Inter_logit_Learn)/(1+exp(tab_results_$Inter_logit_Learn))*100
output_name_ <- paste0(folder_output_,
                       "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                       nomSim_,
                       ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/ProbaAssecFDC0_B")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/ProbaAssecFDC0_BsE")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "ProbaAssecFDCnulle_boot",
                                 # vartitle_ = "Probability of drying\nstate at a zero\nexceedance frequency (%)",
                                 vartitle_ = "Probability (%)",
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenApredire_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenApredire_Brt/ProbaAssecMoyenApredire_B")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
# breaks_ProbaAssecFDCnulle = c(0,0.2,0.4,0.6,0.8,1)
# breaks_ProbaAssecFDCnulle = c(0,20,40,60,80,100)
breaks_ProbaAssecFDCnulle = breaks_ProbaAssecFDCnulle_param
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/2_Map_Globale_Slope_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/2_Map_Globale_Slope_Brt/Slope_B")
# "/TableGlobale/Map_English/2_Map_Globale_Slope_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/2_Map_Globale_Slope_Brt/Slope_BsE")
# "/TableGlobale/Map_English/2_Map_Globale_Slope_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "Slope_logit_Learn",
                                 vartitle_ = bquote("Slope (%"^{-1}~")"),  # Utilisation de expression pour mettre le -1 en exposant
                                 # vartitle_ = "Pente\n(%)",
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/3_Map_Globale_PropDev_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/3_Map_Globale_PropDev_Brt/PropDev_B")
# "/TableGlobale/Map_English/3_Map_Globale_PropDev_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/3_Map_Globale_PropDev_Brt/PropDev_BsE")
# "/TableGlobale/Map_English/3_Map_Globale_PropDev_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "PropParameterDeviance_logit_Learn",
                                 vartitle_ = "Proportion of\ndeviance (%)",
                                 breaks_ = breaks_propDev,
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/4_Map_Globale_KGE_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/4_Map_Globale_KGE_Brt/KGE_B")
# "/TableGlobale/Map_English/4_Map_Globale_KGE_Brt/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/4_Map_Globale_KGE_Brt/KGE_BsE")
# "/TableGlobale/Map_English/4_Map_Globale_KGE_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "KGE_logit_Learn",
                                 vartitle_ = "KGE (unitless)",
                                 breaks_ = breaks_KGE,
...
if(!dir.exists(paste0(folder_output_,
                      ...
                      ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                      ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                      "/TableGlobale/Map_English/8_Map_Globale_NSE_General_Brt/"))){
  dir.create(paste0(folder_output_,
                    "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
                    nomSim_,
                    ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/8_Map_Globale_NSE_General_Brt/NSE_General_NBsE")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/8_Map_Globale_NSE_General_Brt/NSE_General_NonBoot_sansEtiq.pdf")
# "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois09_Brt/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "NASH_logit_Learn",
                                 # vartitle_ = "Mean Absolute Error\nbetween predictions\nand observations of\ndrying state at ONDE sites\n(unitless)",
