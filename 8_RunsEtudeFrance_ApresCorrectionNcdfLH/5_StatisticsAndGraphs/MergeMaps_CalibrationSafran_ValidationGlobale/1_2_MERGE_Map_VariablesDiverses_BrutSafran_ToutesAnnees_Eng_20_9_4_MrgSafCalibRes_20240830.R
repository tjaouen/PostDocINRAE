...
graph_legend_KGE_ <- prepareSubgraph(image_KGE_CTRIP, pos_ = c(1,1), removeLegend = F, removeScale = T, scaleIndx = c(4,5), lastline_ = F)

image_KGE_CTRIP <- prepareSubgraph(image_KGE_CTRIP, pos_ = c(1,1), removeLegend = T, removeScale = T, scaleIndx = c(4,5), lastline_ = T)
image_KGE_GRSD <- prepareSubgraph(image_KGE_GRSD, pos_ = c(1,2), removeLegend = T, removeScale = T, scaleIndx = c(4,5), lastline_ = T)
image_KGE_J2000 <- prepareSubgraph(image_KGE_J2000, pos_ = c(1,3), removeLegend = T, removeScale = T, scaleIndx = c(4,5), lastline_ = T)
image_KGE_ORCHIDEE <- prepareSubgraph(image_KGE_ORCHIDEE, pos_ = c(1,4), removeLegend = T, removeScale = T, scaleIndx = c(4,5), lastline_ =T)
image_KGE_SMASH <- prepareSubgraph(image_KGE_SMASH, pos_ = c(1,5), removeLegend = T, removeScale = T, scaleIndx = c(4,5), lastline_ = T)
...
ggsave(paste0(folder_output_,
              "/15_ResultatsModeles_ValidationParAnnees_ParHer/",
              nomSim_,
              "/TableGlobaleMerge/Map_English/MergeValidSafran_20240830_",
