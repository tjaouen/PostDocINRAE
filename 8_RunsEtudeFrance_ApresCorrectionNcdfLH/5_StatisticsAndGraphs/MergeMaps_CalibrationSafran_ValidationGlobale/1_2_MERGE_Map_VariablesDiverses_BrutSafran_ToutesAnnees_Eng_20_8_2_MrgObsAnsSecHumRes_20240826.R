...
graph_legend_KGE_ <- prepareSubgraph(image_KGE_Obs, pos_ = c(1,1), removeLegend = F)
graph_legend_NSE_ <- prepareSubgraph(image_NSE_Obs, pos_ = c(1,1), removeLegend = F)
graph_legend_Bias_ <- prepareSubgraph(image_Bias_Obs, pos_ = c(1,1), removeLegend = F)
graph_legend_ErrMoyAbs_ <- prepareSubgraph(image_ErrMoyAbs_Obs, pos_ = c(1,1), removeLegend = F)
graph_legend_RMSE_ <- prepareSubgraph(image_RMSE_Obs, pos_ = c(1,1), removeLegend = F)

image_KGE_Obs <- prepareSubgraph(image_KGE_Obs, pos_ = c(1,1), removeLegend = T)
...
image_NSE_Obs <- prepareSubgraph(image_NSE_Obs, pos_ = c(2,1), removeLegend = T)
...
image_Bias_Obs <- prepareSubgraph(image_Bias_Obs, pos_ = c(3,1), removeLegend = T)
...
image_ErrMoyAbs_Obs <- prepareSubgraph(image_ErrMoyAbs_Obs, pos_ = c(4,1), removeLegend = T)
...
image_RMSE_Obs <- prepareSubgraph(image_RMSE_Obs, pos_ = c(5,1), removeLegend = T)
