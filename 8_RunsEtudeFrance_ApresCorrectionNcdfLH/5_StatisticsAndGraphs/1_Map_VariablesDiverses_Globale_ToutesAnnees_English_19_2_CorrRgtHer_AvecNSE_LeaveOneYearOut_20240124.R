...
output_name_ <- paste0(folder_output_,
                       ...
                       "/TableGlobale/Map_English/1_Map_Globale_Intercept_Boot/Intercept_Boot.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_Intercept_Boot/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       "/TableGlobale/Map_English/1_Map_Globale_Intercept_Boot/Intercept_Boot_sansEtiq.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_Intercept_Boot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_Intercept_NonBoot/Intercept_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/ProbaAssecFDCnulle_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/ProbaAssecFDCnulle_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_NonBoot/ProbaAssecFDCnulle_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenApredire_Boot/ProbaAssecMoyenApredire_Boot.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
# breaks_ProbaAssecFDCnulle = c(0,0.2,0.4,0.6,0.8,1)
# breaks_ProbaAssecFDCnulle = c(0,20,40,60,80,100)
breaks_ProbaAssecFDCnulle = breaks_ProbaAssecFDCnulle_param
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenApredire_Boot/ProbaAssecMoyenApredire_Boot_sansEtiq.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenApredire_NonBoot/ProbaAssecMoyenApredire_NonBoot_sansEtiq.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_NonBoot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "P_assecs_HER_MoyenneGlobale_Predit_boot",
                                 # vartitle_ = "Probability of drying\nstate at a zero\nexceedance frequency (%)",
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenPredite_Boot/ProbaAssecMoyenPredite_Boot.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/",str_before_first(basename(filename_),pattern = ".csv"),".pdf")
# breaks_ProbaAssecFDCnulle = c(0,0.2,0.4,0.6,0.8,1)
# breaks_ProbaAssecFDCnulle = c(0,20,40,60,80,100)
breaks_ProbaAssecFDCnulle = breaks_ProbaAssecFDCnulle_param
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenPredite_Boot/ProbaAssecMoyenPredite_Boot_sansEtiq.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_Boot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "P_assecs_HER_MoyenneGlobale_Predit_boot",
                                 # vartitle_ = "Probability of drying\nstate at a zero\nexceedance frequency (%)",
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecMoyenPredite_NonBoot/ProbaAssecMoyenPredite_NonBoot_sansEtiq.pdf")
# "/TableGlobale/Map_English/1_Map_Globale_ProbaAssecFDCnulle_NonBoot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
                                 varname_ = "P_assecs_HER_MoyenneGlobale_Predit_boot",
                                 # vartitle_ = "Probability of drying\nstate at a zero\nexceedance frequency (%)",
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/2_Map_Globale_Slope_Boot/Slope_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/2_Map_Globale_Slope_Boot/Slope_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/2_Map_Globale_Slope_NonBoot/Slope_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/3_Map_Globale_PropDev_Boot/PropDev_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/3_Map_Globale_PropDev_Boot/PropDev_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/3_Map_Globale_PropDev_NonBoot/PropDev_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/4_Map_Globale_KGE_Boot/KGE_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/4_Map_Globale_KGE_Boot/KGE_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/4_Map_Globale_KGE_NonBoot/KGE_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_General_Boot/Biais_General_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_General_Boot/Biais_General_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_General_NonBoot/Biais_General_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_General_Boot/ErrMoyAbs_General_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_General_Boot/ErrMoyAbs_General_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_General_NonBoot/ErrMoyAbs_General_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_General_Boot/RMSE_General_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_General_Boot/RMSE_General_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_General_NonBoot/RMSE_General_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Max3_Boot/Biais_Max3_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Max3_Boot/Biais_Max3_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Max3_NonBoot/Biais_Max3_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Max3_Boot/ErrMoyAbs_Max3_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Max3_Boot/ErrMoyAbs_Max3_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Max3_NonBoot/ErrMoyAbs_Max3_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Max3_Boot/RMSE_Max3_Boot.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Max3_Boot/RMSE_Max3_Boot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Max3_NonBoot/RMSE_Max3_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Mois05_NonBoot/RMSE_Mois05_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Mois06_NonBoot/RMSE_Mois06_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Mois07_NonBoot/RMSE_Mois07_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Mois08_NonBoot/RMSE_Mois08_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/7_Map_Globale_RMSE_Mois09_NonBoot/RMSE_Mois09_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Mois05_NonBoot/Biais_Mois05_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Mois06_NonBoot/Biais_Mois06_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Mois07_NonBoot/Biais_Mois07_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Mois08_NonBoot/Biais_Mois08_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/5_Map_Globale_Biais_Mois09_NonBoot/Biais_Mois09_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois05_NonBoot/ErrMoyAbs_Mois05_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois06_NonBoot/ErrMoyAbs_Mois06_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois07_NonBoot/ErrMoyAbs_Mois07_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois08_NonBoot/ErrMoyAbs_Mois08_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois09_NonBoot/ErrMoyAbs_Mois09_NonBoot_sansEtiq.pdf")
...
output_name_ <- paste0(folder_output_,
                       ...
                       ifelse(nom_apprentissage_=="","",paste0("/",nom_apprentissage_)),
                       ifelse(nom_validation_=="","",paste0("/",nom_validation_)),
                       "/TableGlobale/Map_English/8_Map_Globale_NSE_General_NonBoot/NSE_General_NonBoot_sansEtiq.pdf")
# "/TableGlobale/Map_English/6_Map_Globale_ErrMoyAbs_Mois09_NonBoot/",str_before_first(basename(filename_),pattern = ".csv"),"_sansEtiq.pdf")
plot_map_variable_sansEtiquettes(tab_ = tab_results_,
