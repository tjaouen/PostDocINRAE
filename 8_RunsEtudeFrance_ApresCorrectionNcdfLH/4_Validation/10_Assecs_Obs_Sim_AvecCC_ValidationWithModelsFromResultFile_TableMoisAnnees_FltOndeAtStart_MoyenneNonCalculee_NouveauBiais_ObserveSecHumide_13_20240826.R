...
source("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/8_RunsEtudeFrance_ApresCorrectionNcdfLH/4_Validation/11_Func_Relation_AvecCC_ValidationSansLearn_SansIC_ParMoisAnnees_Observe_10_20240826.R")
...
onde = onde[which((!is.na(onde[,c("Freq_j")])) & !is.na(onde[,c("Freq_jmoins6")])),]
