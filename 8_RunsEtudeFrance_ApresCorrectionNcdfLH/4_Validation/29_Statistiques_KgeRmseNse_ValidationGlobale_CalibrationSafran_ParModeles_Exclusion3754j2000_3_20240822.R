...
tab_globale_3_ <- tab_globale_3_[which(tab_globale_3_$HER != "37054"),]
dim(tab_globale_3_) # 1332

median(tab_globale_3_$KGE_HER_AnneeValid_logit_CValid_general) # 0.692
quantile(tab_globale_3_$KGE_HER_AnneeValid_logit_CValid_general,probs = 0.25) # 0.628
quantile(tab_globale_3_$KGE_HER_AnneeValid_logit_CValid_general,probs = 0.75) # 0.786

tab_globale_3_median_ <- tab_globale_3_ %>%
  group_by(HER) %>%
  summarize(KGE = median(KGE_HER_AnneeValid_logit_CValid_general))
median(tab_globale_3_median_$KGE) # 0.694
table(tab_globale_3_median_$KGE>0.8) # 5/37

median(tab_globale_3_$NASH_HER_AnneeValid_logit_CValid_general) # 0.621
quantile(tab_globale_3_$NASH_HER_AnneeValid_logit_CValid_general,probs = 0.25) # 0.52
quantile(tab_globale_3_$NASH_HER_AnneeValid_logit_CValid_general,probs = 0.75) # 0.709

median(tab_globale_3_$ErreurMoyenneAbsolue_general) # 0.062
quantile(tab_globale_3_$ErreurMoyenneAbsolue_general,probs = 0.25) # 0.043
quantile(tab_globale_3_$ErreurMoyenneAbsolue_general,probs = 0.75) # 0.091

median(tab_globale_3_$RMSE_general) # 0.0925
quantile(tab_globale_3_$RMSE_general,probs = 0.25) # 0.066
quantile(tab_globale_3_$RMSE_general,probs = 0.75) # 0.125

median(tab_globale_3_$Biais_general) # -2e-05
quantile(tab_globale_3_$Biais_general,probs = 0.25) # -5e-05
quantile(tab_globale_3_$Biais_general,probs = 0.75) # 4e-05

median(tab_globale_3_$ErreurMoyenneAbsolue_general) # 0.062
quantile(tab_globale_3_$ErreurMoyenneAbsolue_general,probs = 0.25) # 0.043
quantile(tab_globale_3_$ErreurMoyenneAbsolue_general,probs = 0.75) # 0.091

median(tab_globale_3_$RMSE_general) # 0.09
quantile(tab_globale_3_$RMSE_general,probs = 0.25) # 0.066
quantile(tab_globale_3_$RMSE_general,probs = 0.75) # 0.125

median(tab_globale_3_$P_assecs_HER_MoyenneGlobale_Predit_general) # 12.442 au lieu de 12.3775
