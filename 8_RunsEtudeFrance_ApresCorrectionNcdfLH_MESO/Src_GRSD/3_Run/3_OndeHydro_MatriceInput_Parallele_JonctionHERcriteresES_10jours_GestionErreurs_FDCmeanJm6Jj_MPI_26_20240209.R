...
print('GRSD - 3_OndeHydro_MatriceInput_Parallele_JonctionHERcriteresES_10jours_GestionErreurs_FDCmeanJm6Jj_MPI_26_20240209')
...
liste_scenarios_ = list.files(paste0(folder_input_,"FlowDurationCurves_meanJm6Jj/",
                              ...
                              full.names = T)
# liste_scenarios_ = liste_scenarios_[c(4,5,14,15,16,20,22,29,30,31,33,34)]
