# print("GRSD - 29_ChroniquesParHERpourIndicateurs_ToutesDates_2_20240325.R")
...
list_files_chroniquesProba_ <- list.files(paste0(folder_input_,"Tab_ChroniquesProba_LearnBrut_ByHer/",
                                          ...
                                          recursive = T,
                                          full.names = T)
list_files_chroniquesProba_ <- list_files_chroniquesProba_[grepl("Tab_ChroniquesProba_LearnBrut_ByHer.txt",list_files_chroniquesProba_)]
