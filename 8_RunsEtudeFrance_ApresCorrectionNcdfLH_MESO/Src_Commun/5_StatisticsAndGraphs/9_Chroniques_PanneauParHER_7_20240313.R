...
prepareSubgraph <- function(graph_, pos_, removeLegend = T){
  ...
  if (removeLegend){
    ...
    graph_nl_ <- graph_nl_ + theme(legend.text = element_text(size = 11, color = "grey38"),
                                   legend.title = element_text(size = 11, color = "grey38")) +
...
for (HER_h_ in HER_){
  ...
  rcp85_H0_ = readRDS(paste0(folder_output_DD_,
                             ...
                             year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"/ProbaMeanValue_rcp85_",year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"_HER",HER_h_,"_1_20240227.rds"))
  print("rcp85_H0_ OK")
  ...
  rcp85_H1_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp85/Chroniques/",
                             year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"/ProbaMeanValue_rcp85_",year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"_HER",HER_h_,"_1_20240227.rds"))
  print("rcp85_H1_ OK")
  ...
  rcp85_H2_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp85/Chroniques/",
                             year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"/ProbaMeanValue_rcp85_",year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"_HER",HER_h_,"_1_20240227.rds"))
  print("rcp85_H2_ OK")
  ...
  rcp85_H3_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp85/Chroniques/",
                             year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"/ProbaMeanValue_rcp85_",year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"_HER",HER_h_,"_1_20240227.rds"))
  print("rcp85_H3_ OK")
  ...
  rcp45_H0_ = readRDS(paste0(folder_output_DD_,
                             ...
                             year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"/ProbaMeanValue_rcp45_",year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp45_H0_ OK")
  ...
  rcp45_H1_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp45/Chroniques/",
                             year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"/ProbaMeanValue_rcp45_",year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp45_H1_ OK")
  ...
  rcp45_H2_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp45/Chroniques/",
                             year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"/ProbaMeanValue_rcp45_",year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp45_H2_ OK")
  ...
  rcp45_H3_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp45/Chroniques/",
                             year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"/ProbaMeanValue_rcp45_",year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp45_H3_ OK")
  ...
  rcp26_H0_ = readRDS(paste0(folder_output_DD_,
                             ...
                             year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"/ProbaMeanValue_rcp26_",year(date_intervalle_H0_[1]),year(date_intervalle_H0_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp26_H0_ OK")
  ...
  rcp26_H1_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp26/Chroniques/",
                             year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"/ProbaMeanValue_rcp26_",year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp26_H1_ OK")
  ...
  rcp26_H2_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp26/Chroniques/",
                             year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"/ProbaMeanValue_rcp26_",year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp26_H2_ OK")
  ...
  rcp26_H3_ = readRDS(paste0(folder_output_DD_,
                             ...
                             ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                             "/ChroniquesCombinees_saf_hist_rcp26/Chroniques/",
                             year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"/ProbaMeanValue_rcp26_",year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"_HER",HER_h_,"_bk_1_20240227.rds"))
  print("rcp26_H3_ OK")
  ...
  # Adapter la légende
  rcp85_H0_l_$guides$alpha$keyheight = unit(1.5,"lines")
  ...
  grid_1_ <- grid.arrange(
    ...
    arrangeGrob(
      nullGrob(),
      textGrob("Période de référence (1976-2005)", vjust = 1, gp = gpar(col = "grey38", fontsize = 11)),
      nullGrob(),
      nullGrob(),
      ncol = 4,
  ...
  ggsave(paste0(folder_output_DD_,
                ...
                nomSim_,
                ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                "/PanneauChroniquesCombinees_ParHER/Mean_French/ProbaBoard_MeanFrench_HER",HER_h_,"_1_20240306.svg"),
