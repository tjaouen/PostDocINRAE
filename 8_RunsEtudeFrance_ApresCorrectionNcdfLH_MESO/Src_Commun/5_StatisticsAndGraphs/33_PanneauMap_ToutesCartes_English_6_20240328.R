...
nomCarte_ = "nbMoyenJoursParAnSup10pct_ModeleMedian"
title_ = paste0("Mean number of days per year with\nproportion of droughts exceeding 10%")
subtitle_ = paste0("Hydrological model: ",str_before_first(nom_categorieSimu_,"_"))

# nomCarte_ = "propAssecMoyenneJuilletOct_ModeleMedian"
# title_ = paste0("Probabilités moyennes d'assecs en juillet-octobre\nModèle hydrologique : ",str_before_first(nom_categorieSimu_,"_"))
...
grid_1_ <- grid.arrange(
  ...
  arrangeGrob(
    nullGrob(),
    textGrob("Emission Scenarios Reference (1976-2005)", vjust = 0, gp = gpar(col = "grey38", fontsize = 13)),
    # textGrob("Near-term Horizon (2021-2050)", vjust = 2, gp = gpar(col = "grey38", fontsize = 13)),
    textGrob("Medium-term Horizon (2041-2070)", vjust = 0, gp = gpar(col = "grey38", fontsize = 13)),
    textGrob("Long-term Horizon (2071-2100)", vjust = 0, gp = gpar(col = "grey38", fontsize = 13)),
    # textGrob("Emission Scenarios Reference (1976-2005)", vjust = 2, gp = gpar(col = "grey38", fontsize = 13)),
    # # textGrob("Near-term Horizon (2021-2050)", vjust = 2, gp = gpar(col = "grey38", fontsize = 13)),
    # textGrob("Medium-term Horizon (2041-2070)", vjust = 2, gp = gpar(col = "grey38", fontsize = 13)),
    # textGrob("Long-term Horizon (2071-2100)", vjust = 2, gp = gpar(col = "grey38", fontsize = 13)),
    ncol = 4,
    # ncol = 5,
  ...
  # Ligne 5
  arrangeGrob(
    textGrob("RCP 2.6",vjust = 1, gp = gpar(col = "grey38", fontsize = 13), rot = 90),
  ...
  # Ligne 6
  arrangeGrob(
    textGrob("RCP 4.5",vjust = 1, gp = gpar(col = "grey38", fontsize = 13), rot = 90),
  ...
  # Ligne 7
  arrangeGrob(
    textGrob("RCP 8.5",vjust = 1, gp = gpar(col = "grey38", fontsize = 13), rot = 90),
...
ggsave(paste0(folder_output_DD_,
              ...
              nomSim_,
              ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
              "/PanneauMap/Mean_English/ProbaBoard_",nomCarte_,"_English_1_20240328.svg"),
