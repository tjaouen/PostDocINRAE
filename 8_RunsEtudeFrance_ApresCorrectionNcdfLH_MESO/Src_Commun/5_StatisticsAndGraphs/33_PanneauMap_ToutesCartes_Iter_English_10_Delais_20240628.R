...
prepareSubgraph <- function(graph_, pos_, removeLegend = T, removeScale = T, scaleIndx, lastline_ = F){
  ...
  if (removeScale){
    ...
    graph_nl_$layers[[scaleIndx[1]]]$geom_params$pad_y = unit(0.1,"cm")
    graph_nl_$layers[[scaleIndx[2]]]$geom_params$pad_x = unit(1,"cm")
    graph_nl_$layers[[scaleIndx[2]]]$geom_params$pad_y = unit(0,"cm")
  }
...
for (nom_categorieSimu_ in nom_categorieSimu_list_){
  ...
  for (df_line_ in 1:nrow(data_frame_graphes_)){
    ...
    #                            ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
    #                            "/ChroniquesCombinees_saf_hist_rcp85/Map/",
    #                            "/Map_",nomCarte_,"_",year(date_intervalle_H1_[1]),year(date_intervalle_H1_[2]),"_1_20240711_sansTxt_sansEt.rds"))
    # print("rcp85_H1_ OK")
    ...
    rcp85_H2_ = readRDS(paste0(folder_output_DD_,
                               ...
                               ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                               "/ChroniquesCombinees_saf_hist_rcp85/Map/",
                               "/Map_",nomCarte_,"_",year(date_intervalle_H2_[1]),year(date_intervalle_H2_[2]),"_1_20240711_sansTxt_sansEt.rds"))
    print("rcp85_H2_ OK")
    ...
    rcp85_H3_ = readRDS(paste0(folder_output_DD_,
                               ...
                               ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                               "/ChroniquesCombinees_saf_hist_rcp85/Map/",
                               "/Map_",nomCarte_,"_",year(date_intervalle_H3_[1]),year(date_intervalle_H3_[2]),"_1_20240711_sansTxt_sansEt.rds"))
    print("rcp85_H3_ OK")
    ...
    rcp26_H0_nl_ <- prepareSubgraph(rcp26_H0_, pos_ = c(1,1), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp26_H2_nl_ <- prepareSubgraph(rcp26_H2_, pos_ = c(1,2), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp26_H3_nl_ <- prepareSubgraph(rcp26_H3_, pos_ = c(1,3), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp45_H0_nl_ <- prepareSubgraph(rcp45_H0_, pos_ = c(2,1), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp45_H2_nl_ <- prepareSubgraph(rcp45_H2_, pos_ = c(2,2), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp45_H3_nl_ <- prepareSubgraph(rcp45_H3_, pos_ = c(2,3), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = F)
    rcp85_H0_nl_ <- prepareSubgraph(rcp85_H0_, pos_ = c(1,1), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = T)
    rcp85_H0_l_ <- prepareSubgraph(rcp85_H0_, pos_ = c(1,1), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = T)
    rcp85_H2_nl_ <- prepareSubgraph(rcp85_H2_, pos_ = c(3,2), removeLegend = T, removeScale = T, scaleIndx = c(2,3), lastline_ = T)
    rcp85_H3_nl_ <- prepareSubgraph(rcp85_H3_, pos_ = c(3,3), removeLegend = T, removeScale = F, scaleIndx = c(2,3), lastline_ = T)
    
    # graph_legend_ <- rcp85_H3_
    graph_legend_ <- graph_legend_ + theme(legend.position =  "bottom",
                                           legend.text = element_text(colour = "grey38", size = 12*ratio_epaisseurs_, hjust = -2),
                                           # legend.title = element_text(colour = "grey38", size = 12*ratio_epaisseurs_, hjust = -2),
    ...
    graph_legend_$theme$legend.direction = "horizontal"
    graph_legend_$theme$legend.text$vjust = unit(-5,"cm")
    graph_legend_$theme$legend.text$hjust = unit(-2,"cm")
    # graph_legend_$theme$legend.title$hjust = unit(1,"cm")
    ...
    grid_1_ <- grid.arrange(
      ...
      arrangeGrob(
        ...
        textGrob("Long-term horizon\n(2070-2099)", vjust = 0, gp = gpar(col = "grey38", fontsize = 16*ratio_epaisseurs_)),
    ...
    ggsave(paste0(folder_output_DD_,
                  ...
                  nomCarte_,"_English_1_20240711.svg"),
    ...
    ggsave(paste0(folder_output_DD_,
                  ...
                  "/PanneauMap/Mean_English/ProbaBoard_",
                  ifelse(nom_categorieSimu_=="","",str_before_first(nom_categorieSimu_,"/")),"_",
                  nomCarte_,"_English_1_20240711.png"),
           plot = grid_1_)
    ...
    ggsave(paste0(folder_output_DD_,
                  ...
                  "/PanneauMap/Mean_English/ProbaBoard_",
                  ifelse(nom_categorieSimu_=="","",str_before_first(nom_categorieSimu_,"/")),"_",
                  nomCarte_,"_English_1_20240711.pdf"),
           plot = grid_1_) # width=15
