...
for (HER_h_ in HER_){
  ...
  grid_1_ <- grid.arrange(
    ...
    arrangeGrob(
      nullGrob(),
      textGrob("Reference Emission Scenarios (1976-2005)", vjust = 1, gp = gpar(col = "grey38", fontsize = 11)),
      nullGrob(),
      nullGrob(),
      ncol = 4,
  ...
  grid_graph_ <- grid.arrange(
    ...
    arrangeGrob(
      ...
      textGrob("Near-term Horizon (2021-2050)", vjust = 2, gp = gpar(col = "grey38", fontsize = 11)),
      nullGrob(),
      textGrob("Medium-term Horizon (2041-2070)", vjust = 2, gp = gpar(col = "grey38", fontsize = 11)),
      textGrob("Long-term Horizon (2071-2100)", vjust = 2, gp = gpar(col = "grey38", fontsize = 11)),
      ncol = 5,
      widths = c(w_col1_,w_col2_,w_col3_,w_col4_,w_col5_),
      padding = unit(0.1, "cm")),
  ...
  ggsave(paste0(folder_output_DD_,
                ...
                nomSim_,
                ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                "/PanneauChroniquesCombinees_ParHER/Median_English/ProbaBoard_MedianEnglish_HER",HER_h_,"_1_20240410.svg"),
