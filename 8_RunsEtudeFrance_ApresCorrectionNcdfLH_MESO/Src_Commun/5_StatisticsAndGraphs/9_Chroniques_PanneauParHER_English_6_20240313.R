...
for (HER_h_ in HER_[1]){
  ...
  ggsave(paste0(folder_output_DD_,
                ...
                nomSim_,
                ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                "/PanneauChroniquesCombinees_ParHER/Mean_English/ProbaBoard_MeanEnglish_HER",HER_h_,"_1_20240408.svg"),
  ...
  ggsave(paste0(folder_output_DD_,
                ...
                nomSim_,
                ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                "/PanneauChroniquesCombinees_ParHER/Mean_English/ProbaBoard_MeanEnglish_HER",HER_h_,"_1_20240408.pdf"),
         plot = grid_totale_) # , width=15
  ...
  ggsave(paste0(folder_output_DD_,
                ...
                nomSim_,
                ifelse(nom_categorieSimu_=="","",paste0("/",str_before_first(nom_categorieSimu_,"/"))),
                "/PanneauChroniquesCombinees_ParHER/Mean_English/ProbaBoard_MeanEnglish_HER",HER_h_,"_1_20240408.png"),
