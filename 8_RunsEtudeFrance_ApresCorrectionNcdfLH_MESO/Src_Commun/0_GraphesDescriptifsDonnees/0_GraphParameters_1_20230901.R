...
# breaks_nbJoursAssecsAn_param = c(0,25,50,75,100,125,150,175,200)
breaks_nbJoursAssecsAn_param = c(-1,0,25,50,75,100,125,150,175,200)
breaks_dateMediane_start_param = c("2020-04-01","2020-05-01","2020-06-01","2020-07-01","2020-08-01","2020-09-01","2020-10-01")
...
# breaks_dateMediane_end_param = c("2020-07-01","2020-08-01","2020-09-01","2020-10-01","2020-11-01","2020-12-01","2021-01-01","2021-02-01","2021-03-01")
breaks_dateMediane_end_param = c("2020-09-01","2020-10-01","2020-11-01","2020-12-01","2021-01-01","2021-02-01","2021-03-01")
# breaks_nbJoursDelai_param = c(-14,-7,0,7,14,21,28,35,42)
breaks_nbJoursDelai_param = c(-30,-4,-1,0,1,2,3,5,7,30)
# breaks_nbJoursDelai_param = c(-7,-4,-1,0,1,2,3,4,5,7)
# breaks_nbJoursDelai_param = c(-7,-3,-1,0,1,2,3,4,5,6)
# breaks_nbJoursDelai_param = c(-2,-1,0,1,2,3,4,5,6)
# breaks_nbJoursDelai_param = c(-4,-2,0,1,2,3,5,7)
