...
prepareSubgraph <- function(graph_, pos_, removeLegend = T){
  ...
  if (removeLegend){
    ...
    # graph_nl_ <- graph_nl_ + theme(legend.text = element_text(size = 16),
...
global_GCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere_rcp264585/rcp26andrcp45and85/7_ChroniquesPFI_EffectGCM_rcp26andrcp45and85_1_20240526.rds"
global_RCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere_rcp264585/rcp26andrcp45and85/7_ChroniquesPFI_EffectRCM_rcp26andrcp45and85_1_20240526.rds"
global_HM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere_rcp264585/rcp26andrcp45and85/8_ChroniquesPFI_EffectHM_rcp26andrcp45and85_1_20240526.rds"
global_RCP_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere_rcp264585/rcp26andrcp45and85/8_ChroniquesPFI_EffectRCP_rcp26andrcp45and85_1_20240526.rds"
global_MeanChangeAndUncertainties_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere_rcp264585/rcp26andrcp45and85/10_ChroniquesPFI_MeanChangeAndUncertainties_rcp26andrcp45and85_1_20240526.rds"
...
carte_GCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_GCM_1_20240619_sansTxt_sansEt.rds"
carte_RCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_RCM_1_20240619_sansTxt_sansEt.rds"
carte_HM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_HM_1_20240619_sansTxt_sansEt.rds"
carte_RCP_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_RCP_1_20240619_sansTxt_sansEt.rds"
carte_InternalVar_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_InternalVar_1_20240619_sansTxt_sansEt.rds"
carte_ResidualVar_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/MapIncertitude_ResidualVar_1_20240619_sansTxt_sansEt.rds"
...
global_MeanChangeAndUncertainties_$theme$legend.text$colour = "grey38"
...
carte_GCM_ <- carte_GCM_ + theme(legend.position =  "bottom",
                                 ...
                                 legend.title = element_text(colour = "grey38",size = 18*ratio_epaisseurs_),
                                 # size = 12*ratio_epaisseurs_),
                                 legend.direction = "horizontal",
                                 legend.margin = margin(0, 0, 0, +140), # Réduire les marges de la légende
...
grid_scale_ <- grid.arrange(
  ...
  arrangeGrob(
    ...
    widths = c(w_col2_+w_col3_/2, w_col3_/2, w_col4_),
...
grid_1_ <- grid.arrange(
  ...
  #   
  #   ncol = 3,
  #   widths = c(w_col4_/2,w_col2_+w_col4_/2,w_col3_),
  #   padding = unit(-3, "cm")),
  
  arrangeGrob(
    textGrob("PFI change", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("RCP", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("GCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
  ...
  arrangeGrob(
    # nullGrob(),
    textGrob("RCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("HM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("Residual variability", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 16 * ratio_epaisseurs_), rot = 0),
...
ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Merge/Merge_ProbaMeanJuilOct_Cadran6_2_20240715",
              # ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Merge/Merge_ProbaMeanJuilOct_Cadran6_2_20240715",
              ".tiff"),
       grid_1_,
       width = 12, height = 8)
