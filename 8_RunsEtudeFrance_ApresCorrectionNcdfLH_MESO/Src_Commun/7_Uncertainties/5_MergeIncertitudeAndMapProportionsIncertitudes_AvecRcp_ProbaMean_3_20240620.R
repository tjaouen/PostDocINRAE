...
prepareSubgraph <- function(graph_, pos_, removeLegend = T){
  ...
  if (removeLegend){
    ...
    graph_nl_ <- graph_nl_ + theme(legend.text = element_text(size = 12),
...
global_GCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere/rcp45and85/7_ChroniquesPFI_EffectGCM_rcp45and85_1_20240526.rds"
global_RCM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere/rcp45and85/7_ChroniquesPFI_EffectRCM_rcp45and85_1_20240526.rds"
global_HM_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere/rcp45and85/8_ChroniquesPFI_EffectHM_rcp45and85_1_20240526.rds"
global_RCP_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere/rcp45and85/8_ChroniquesPFI_EffectRCP_rcp45and85_1_20240526.rds"
global_MeanChangeAndUncertainties_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526/Global/ProbaMeanJuilOct_SplitRCPGCM_Pondere/rcp45and85/10_ChroniquesPFI_MeanChangeAndUncertainties_rcp45and85_1_20240526.rds"
# global_MeanChangeAndUncertainties_ <- "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240526_save/Global/ProbaMeanJuilOct/rcp45and85/10_ChroniquesPFI_MeanChangeAndUncertainties_rcp45and85_1_20240526.rds"
...
# ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240619/Merge/TestGCM",
#               ".tiff"),
#        global_GCM_,
#        width = 20, height = 12)
# ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240619/Merge/TestRCM",
#               ".tiff"),
#        global_RCM_,
#        width = 20, height = 12)
# ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240619/Merge/TestHM",
#               ".tiff"),
#        global_HM_,
#        width = 20, height = 12)
...
global_MeanChangeAndUncertainties_$theme$legend.text$size <- 10
...
global_RCP_ <- global_RCP_ + theme(axis.text.y = element_blank())
...
carte_GCM_ <- carte_GCM_ + theme(legend.position =  "bottom",
                                 legend.text = element_text(colour = "grey38", size = 10*ratio_epaisseurs_),
...
grid_1_ <- grid.arrange(
  ...
  arrangeGrob(
    ...
    textGrob("Residual variability", vjust = 1, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
  ...
  arrangeGrob(
    # textGrob("Proportion of\nthe variability (%)", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 12 * ratio_epaisseurs_), rot = 0),
    # cowplot::get_legend(graph_legend_),
    legend_proportions,
    nullGrob(),
    nullGrob(),
    ...
    nullGrob(),
    nullGrob(),
    textGrob("PFI change", vjust = 5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),

    ncol = 7,
    widths = c(w_col1_+w_col2_+w_col3_,0,0,w_col4_, w_col5_, w_col6_, w_col7_),
    padding = unit(0, "cm")),
  ...
  # nrow = 4,
  # heights = c(h_line1_, h_line2_, h_lineScale_, h_line3_),
  # padding = unit(3, "cm")
...
# ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240619/Merge/Test",
#               ".tiff"),
#        global_RCM_,
#        width = 20, height = 12)
