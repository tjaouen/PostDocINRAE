...
ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Merge/Merge_ProbaMeanJuilOct_1_20240620",
              ".tiff"),
       grid_1_,
       width = 20, height = 12)
...
grid_1_ <- grid.arrange(
  ...
  arrangeGrob(
    # nullGrob(),
    textGrob("RCP", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("GCM", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("RCM", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
  ...
  arrangeGrob(
    # nullGrob(),
    textGrob("HM", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("Residual variability", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    # textGrob("Internal\nvariability", vjust = 1, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    # textGrob("PFI change", vjust = 5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
    textGrob("PFI change", vjust = 0.5, gp = gpar(col = "#2f2f32", fontsize = 16 * ratio_epaisseurs_), rot = 0),
...
ggsave(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Merge/Merge_ProbaMeanJuilOct_Cadran6_1_20240620",
              ".tiff"),
       grid_1_,
       width = 20, height = 12)
