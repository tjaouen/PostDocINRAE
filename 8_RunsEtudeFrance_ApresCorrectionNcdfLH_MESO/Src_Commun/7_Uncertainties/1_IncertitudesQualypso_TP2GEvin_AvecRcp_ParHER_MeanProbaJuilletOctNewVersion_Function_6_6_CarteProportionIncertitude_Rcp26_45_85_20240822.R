...
runPlot <- function(Y,scenAvail,X_time_vec,Xfut_time,nomSimulation_,ylim_,ylim_enveloppe_){
  ...
  # if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/"))){
  #   dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/"))
  # }
  # if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/"))){
  #   dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/"))
  # }
  # if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/",nomSimulation_,"/"))){
  #   dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/",nomSimulation_,"/"))
  # }
  if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/"))){
    dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/"))
  }
  if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/"))){
    dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/"))
  }
  if (!dir.exists(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/",nomSimulation_,"/"))){
    dir.create(paste0("/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/33_Exclusion37054_20240822/StatistiquesPFI/Incertitudes/Version_1_20240703/Global/",nomVariable_,"/",nomSimulation_,"/"))
  }
...
ylim_param_ = c(-0.8,0.8)
# ylim_enveloppe_param_ = c(-2.5,2.5)
ylim_enveloppe_param_ = c(-1.5,1.5)
...
list_files_ <- list.files("/media/tjaouen/Ultra Touch/Backup/Main/Input/HYDRO/EtudeFrance/Tab_ChroniquesProba_LearnBrut_ByHer/FDC_Projections/",
                          pattern = "Tab_AnnualMeanJuilletOctobrePondere.txt", full.names = T, recursive = T, include.dirs = F)
...
# Les projections de moyennes de température hivernale pour 20 simulations de 129 Years sont contenus dans Y sous la forme d'une matrice 20 x 129
list_files_ <- list.files("/media/tjaouen/Ultra Touch/Backup/Main/Input/HYDRO/EtudeFrance/Tab_ChroniquesProba_LearnBrut_ByHer/FDC_Projections/",
                          # pattern = "Tab_AnnualMeanPondere.txt", full.names = T, recursive = T, include.dirs = F)
                          pattern = "Tab_AnnualMeanJuilletOctobrePondere.txt", full.names = T, recursive = T, include.dirs = F)
# list_files_ <- list_files_[grepl("CTRIP",list_files_)]
list_files_ <- list_files_[grepl("ADAMONT",list_files_)]
...
ind_ <- which(scenAvail_rcp26and45and85$HM %in% c("CTRIP","GRSD","ORCHIDEE","SMASH"))
