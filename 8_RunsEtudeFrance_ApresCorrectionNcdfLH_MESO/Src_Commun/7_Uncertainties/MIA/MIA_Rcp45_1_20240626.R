...
for (HER_ in HER_list_){
  ...
  Y_rcp45_ref_ <- Y_rcp45[,which(colnames(Y_rcp45) %in% date_ref_)]
  Y_rcp45_ref_mean_ <- rowMeans(Y_rcp45_ref_)
  
  Y_rcp45_finSiecle_ <- Y_rcp45[,which(colnames(Y_rcp45) %in% date_finSiecle_)]
  Y_rcp45_finSiecle_mean_ <- rowMeans(Y_rcp45_finSiecle_)
  
  Y_comp_ <- data.frame(ifelse(Y_rcp45_ref_mean_<Y_rcp45_finSiecle_mean_, 1, ifelse(Y_rcp45_ref_mean_>Y_rcp45_finSiecle_mean_,-1,0)))
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_CTRIP_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 # breaks_ = breaks_ProbaAssecMoyenne,
                                 breaks_ = c(-100,-80,-60,-40,-20,0,20,40,60,80,100),
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_GRSD_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
                                 # nomPalette_ = "cryo_div_disc.txt",
                                 # nomPalette_ = "sequence_beigeBleu_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
                                 # nomPalette_ = "sequence_vertMarron_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 # breaks_ = breaks_ProbaAssecMoyenne,
                                 breaks_ = c(-100,-80,-60,-40,-20,0,20,40,60,80,100),
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_J2000_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
                                 # nomPalette_ = "cryo_div_disc.txt",
                                 # nomPalette_ = "sequence_beigeBleu_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
                                 # nomPalette_ = "sequence_vertMarron_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 # breaks_ = breaks_ProbaAssecMoyenne,
                                 breaks_ = c(-100,-80,-60,-40,-20,0,20,40,60,80,100),
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_ORCHIDEE_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
                                 # nomPalette_ = "cryo_div_disc.txt",
                                 # nomPalette_ = "sequence_beigeBleu_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
                                 # nomPalette_ = "sequence_vertMarron_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 # breaks_ = breaks_ProbaAssecMoyenne,
                                 breaks_ = c(-100,-80,-60,-40,-20,0,20,40,60,80,100),
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_SMASH_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
                                 # nomPalette_ = "cryo_div_disc.txt",
                                 # nomPalette_ = "sequence_beigeBleu_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
                                 # nomPalette_ = "sequence_vertMarron_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
...
plot_map_variable_sansEtiquettes(tab_ = col_means_merge,
                                 ...
                                 # breaks_ = breaks_ProbaAssecMoyenne,
                                 breaks_ = c(-100,-80,-60,-40,-20,0,20,40,60,80,100),
                                 output_name_ = "/media/tjaouen/Ultra Touch/Backup/Main/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/StatistiquesPFI/MIA/Map/IndexMIAparHER_Total_Rcp45_1_20240625",
                                 title_ = paste0("MIA"),
                                 # nomPalette_ = "cryo_div_disc.txt",
                                 # nomPalette_ = "sequence_beigeBleu_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
                                 # nomPalette_ = "sequence_vertMarron_personnelle_div_disc.txt", # "sequence_vertRouge_personnelle_div_disc.txt"
