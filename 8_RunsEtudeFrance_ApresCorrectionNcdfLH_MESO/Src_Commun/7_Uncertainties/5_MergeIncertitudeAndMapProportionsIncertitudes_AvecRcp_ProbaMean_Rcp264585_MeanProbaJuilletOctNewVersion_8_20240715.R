...
grid_1_ <- grid.arrange(
  ...
  arrangeGrob(
    textGrob("(A) PFI change", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("(B) RCP", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("(C) GCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
  ...
  arrangeGrob(
    # nullGrob(),
    textGrob("(D) RCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("(E) HM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("(F) Residual variability", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
