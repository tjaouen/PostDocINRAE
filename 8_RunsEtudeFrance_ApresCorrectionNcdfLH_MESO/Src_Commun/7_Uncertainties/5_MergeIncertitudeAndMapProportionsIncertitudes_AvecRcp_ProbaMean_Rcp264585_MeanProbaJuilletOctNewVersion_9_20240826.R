...
grid_1_ <- grid.arrange(
  ...
  arrangeGrob(
    textGrob("PFI change", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("RCP", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("GCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
  ...
  arrangeGrob(
    # nullGrob(),
    textGrob("RCM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("HM", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
    textGrob("Residual variability", vjust = 0.5, gp = gpar(col = "grey38", fontsize = 20 * ratio_epaisseurs_), rot = 0),
  ...
  nrow = 5,
  heights = c(h_lineScale_, h_line1_, h_line2_, h_line1_, h_line2_),
