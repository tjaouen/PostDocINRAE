...
for (HER_h_ in HER_[1]){
  ...
  if (HER_h_ %in% colnames(tab_1_)){
    ...
    #     grepl("CNRM-CERFACS.*CNRM-ALADIN63_v3_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("CNRM-CERFACS.*CNRM-ALADIN63_v3_MF-ADAMONT", Variable) ~ 1,
    #     grepl("CNRM-CERFACS.*MOHC-HadREM3-GA7-05_v3_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("CNRM-CERFACS.*MOHC-HadREM3-GA7-05_v3_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("ICHEC-EC-EARTH.*KNMI-RACMO22E_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("ICHEC-EC-EARTH.*KNMI-RACMO22E_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("ICHEC-EC-EARTH.*MOHC-HadREM3-GA7-05_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("ICHEC-EC-EARTH.*MOHC-HadREM3-GA7-05_v2_MF-ADAMONT", Variable) ~ 1,
    #     grepl("ICHEC-EC-EARTH.*SMHI-RCA4_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("ICHEC-EC-EARTH.*SMHI-RCA4_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("IPSL-IPSL-CM5A-MR.*DMI-HIRHAM5_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("IPSL-IPSL-CM5A-MR.*DMI-HIRHAM5_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("IPSL-IPSL-CM5A-MR.*SMHI-RCA4_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("IPSL-IPSL-CM5A-MR.*SMHI-RCA4_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*CLMcom-CCLM4-8-17_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*CLMcom-CCLM4-8-17_v2_MF-ADAMONT", Variable) ~ 1,
    #     grepl("MOHC-HadGEM2-ES.*CNRM-ALADIN63_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*CNRM-ALADIN63_v2_MF-ADAMONT", Variable) ~ 1,
    #     grepl("MOHC-HadGEM2-ES.*ICTP-RegCM4-6_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*ICTP-RegCM4-6_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*MOHC-HadREM3-GA7-05_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MOHC-HadGEM2-ES.*MOHC-HadREM3-GA7-05_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*CLMcom-CCLM4-8-17_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*CLMcom-CCLM4-8-17_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*ICTP-RegCM4-6_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*ICTP-RegCM4-6_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*MPI-CSC-REMO2009_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("MPI-M-MPI-ESM-LR.*MPI-CSC-REMO2009_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*DMI-HIRHAM5_v4_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*DMI-HIRHAM5_v4_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*GERICS-REMO2015_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*GERICS-REMO2015_v2_MF-ADAMONT", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*IPSL-WRF381P_v2_LSCE-IPSL_CDFt", Variable) ~ 0.15,
    #     grepl("NCC-NorESM1-M.*IPSL-WRF381P_v2_MF-ADAMONT", Variable) ~ 0.15))
    ...
    # scale_color_manual(values = c("#E5E840", "#E2A138", "#70194E", "#447C57","#2b8cbe","black"),
    #                    labels = desired_order)+
    # scale_color_manual(values = factor(unique(df_mean$Color,levels = c("#E5E840", "#E2A138", "#70194E", "#447C57","black"))),
    #                    labels = factor(unique(df_mean$af,levels = desired_order)))+
    
    # scale_linetype_manual(values = c("solid", "dashed"),
    #                       labels = desired_order_lty)+
    ...
    x11()
    p_mean <- ggplot() +
      geom_line(data = df_mean, aes(x = Jour_annee, y = Mean_ValueLissee, group = Variable, color = Legend), alpha = 0.15, lwd = 2) + # linetype = Type, 
      scale_color_manual(values = levels(df_mean$Color))+
      # scale_color_manual(values = unique(df_mean$Color),
      #                    labels = unique(df_mean$Legend))+
      ...
      labs(title = paste0("Moyenne des probabilités d'assecs lissées sur 5 jours (1976-2005) - HER ",HER_h_),
           x = "Date",
      ...
      guides(alpha = FALSE,
             color = guide_legend(override.aes = list(lwd=2.5, alpha = c(rep(1,length(levels(df_mean$Color))-1),0.15)),
                                  keyheight = 2.8))
    ...
    svg_device <- svglite(paste0(folder_output_,
                                 ...
                                 nomSim_,
                                 ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                 "/Chroniques/ProbaMeanValue_rcp85_20702100_HER",HER_h_,"_1_20240226.svg"),
                          width = 15)
    print(p_mean)
    dev.off()
    ...
    p_median <- ggplot() +
      ...
      # labels = Legend) +
      # geom_point(data = first_days, aes(x = Date, y = 0), size = 0, alpha = 0) +
      labs(title = paste0("Médianne des probabilités d'assecs lissées sur 5 jours (1976-2005) - HER ",HER_h_),
           x = "Date",
      ...
      theme(strip.text.x = element_blank(),
            ...
            text = element_text(size = 20))+#,
      guides(alpha = FALSE,
             color = guide_legend(override.aes = list(lwd=2.5, alpha = c(1,1,1,1,0.15)),
                                  keyheight = 2.8))
