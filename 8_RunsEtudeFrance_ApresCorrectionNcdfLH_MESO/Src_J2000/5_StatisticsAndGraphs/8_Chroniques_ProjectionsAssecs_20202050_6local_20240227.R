print("J2000 - 8_Chroniques_ProjectionsAssecs_20202050_6local_20240227.R")
...
for (HER_h_ in HER_[1]){
  ...
  if (HER_h_ %in% colnames(tab_1_)){
    ...
    if (!(nrow(tab_allModels_2070_2100_[which(tab_allModels_2070_2100_$Type == "Historical"),]) %in% c(as.Date("2050-07-31")-as.Date("2020-08-01")+1,0))){
      stop(paste0("Error with Historical content. File :", list_files_chroniquesProba_[l], " - HER : ", HER_h_))
    }
    if (!(nrow(tab_allModels_2070_2100_[which(tab_allModels_2070_2100_$Type == "Safran"),]) %in% c(as.Date("2050-07-31")-as.Date("2020-08-01")+1,0))){
      stop(paste0("Error with Safran content. File :", list_files_chroniquesProba_[l], " - HER : ", HER_h_))
    }
    if (!(nrow(tab_allModels_2070_2100_[grepl("rcp",tab_allModels_2070_2100_$Type),]) %in% c(as.Date("2050-07-31")-as.Date("2020-08-01")+1,0))){
    ...
    p_mean <- ggplot() +
      ...
      labs(title = paste0("Moyenne des probabilités d'assecs lissées sur 5 jours (2020-2050)\nModèle hydrologique ",str_before_first(nom_categorieSimu_,"_")," - HER ",HER_h_),
           x = "Date",
    ...
    svg_device <- svglite(paste0(folder_output_,
                                 ...
                                 nomSim_,
                                 ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                 "/Chroniques/ProbaMeanValue_rcp85_20202050_HER",HER_h_,"_1_20240227.svg"),
                          width = 15)
    print(p_mean)
    dev.off()
    saveRDS(p_mean, file = paste0(folder_output_,
                                  ...
                                  nomSim_,
                                  ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                  "/Chroniques/ProbaMeanValue_rcp85_20202050_HER",HER_h_,"_1_20240227.rds"))
    ...
    p_mean <- ggplot() +
      ...
      labs(title = paste0("Mean smoothed drought probabilities over 5 days (2020-2050)\nHydrological Model ",str_before_first(nom_categorieSimu_,"_")," - HER ",HER_h_),
           x = "Date",
    ...
    svg_device <- svglite(paste0(folder_output_,
                                 ...
                                 nomSim_,
                                 ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                 "/Chroniques/Eng/ProbaMeanValue_rcp85_20202050_HER",HER_h_,"_Eng_1_20240227.svg"),
                          width = 15)
    print(p_mean)
    dev.off()
    saveRDS(p_mean, file = paste0(folder_output_,
                                  ...
                                  nomSim_,
                                  ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                  "/Chroniques/Eng/ProbaMeanValue_rcp85_20202050_HER",HER_h_,"_Eng_1_20240227.rds"))
    ...
    p_median <- ggplot() +
      ...
      labs(title = paste0("Médiane des probabilités d'assecs lissées sur 5 jours (2020-2050)\nModèle hydrologique ",str_before_first(nom_categorieSimu_,"_")," - HER ",HER_h_),
           x = "Date",
    ...
    svg_device <- svglite(paste0(folder_output_,
                                 ...
                                 nomSim_,
                                 ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                 "/Chroniques/ProbaMedianValue_rcp85_20202050_HER",HER_h_,"_1_20240227.svg"),
                          width = 15)
    print(p_median)
    dev.off()
    saveRDS(p_mean, file = paste0(folder_output_,
                                  ...
                                  nomSim_,
                                  ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                  "/Chroniques/ProbaMedianValue_rcp85_20202050_HER",HER_h_,"_1_20240227.rds"))
    ...
    p_median <- ggplot() +
      ...
      labs(title = paste0("Median smoothed drought probabilities over 5 days (2020-2050)\nHydrological Model ",str_before_first(nom_categorieSimu_,"_")," - HER ",HER_h_),
           x = "Date",
    ...
    svg_device <- svglite(paste0(folder_output_,
                                 ...
                                 nomSim_,
                                 ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                 "/Chroniques/Eng/ProbaMedianValue_rcp85_20202050_HER",HER_h_,"_Eng_1_20240227.svg"),
                          width = 15)
    print(p_median)
    dev.off()
    saveRDS(p_mean, file = paste0(folder_output_,
                                  ...
                                  nomSim_,
                                  ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                                  "/Chroniques/Eng/ProbaMedianValue_rcp85_20202050_HER",HER_h_,"_Eng_1_20240227.rds"))
    ...
    write.table(df_mean,paste0(folder_output_,
                               ...
                               nomSim_,
                               ifelse(nom_categorieSimu_=="","",paste0("/",nom_categorieSimu_)),
                               "/Tables/Table_ProbaMeanValue_rcp85_20202050_HER",HER_h_,"_1_20240214.csv"),
                sep = ";", dec = ".", row.names = F)
