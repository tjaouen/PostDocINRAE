...
# files <- list.files("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/J2000_20231128/ChroniquesCombinees_saf_hist_rcp85/Tables/", full.names = TRUE)
files <- list.files("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/GRSD_20231128/ChroniquesCombinees_saf_hist_rcp85/Tables/", full.names = TRUE)
...
# table_globale$HER2 = as.numeric(table_globale$HER)
plot_map_variable(tab_ = table_globale,
                  varname_ = "Moyenne_Mean_Value",
                  vartitle_ = "Proba moyenne assec mai-septembre 1976-2005",
                  # vartitle_ = "Proba moyenne assec mai-septembre 2070-2100",
                  ...
                  # output_name_ = "/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/J2000_20231128/ChroniquesCombinees_saf_hist_rcp85/Map/Map_19762005_1_20240227_",
                  # title_ = paste0("Proba moyenne assec juillet-octobre 2070-2100"),
...
plot_map_variable_sansEtiquettes(tab_ = table_globale,
                  varname_ = "Moyenne_Mean_Value",
                  vartitle_ = "Proba moyenne assec juillet-octobre 1976-2005",
                  # vartitle_ = "Proba moyenne assec mai-septembre 2070-2100",
                  breaks_ = breaks_ProbaAssecMoyenne,
                  output_name_ = "/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/GRSD_20231128/ChroniquesCombinees_saf_hist_rcp85/Map/Map_19762005_1_20240227_sansEt_",
                  # output_name_ = "/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/22_GrapheChroniqueProbabilite_OneModelHorizon20702100_Projections/32_ObservesReanalyseSafran_ApprentissageTousScenariosProjections_20240208/J2000_20231128/ChroniquesCombinees_saf_hist_rcp85/Map/Map_19762005_1_20240227_",
                  # title_ = paste0("Proba moyenne assec juillet-octobre 2070-2100"),
                  title_ = paste0("Proba moyenne assec juillet-octobre 1976-2005"),
                  nomPalette_ = "misc_div_disc.txt",
