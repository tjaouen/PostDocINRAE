...
for (HER_h_ in HER_[1]){
  ...
  if (HER_h_ %in% colnames(tab_1_)){
    ...
    p_mean <- ggplot() +
      ...
      # scale_linetype_manual(values = levels(df_mean$LineType))+
      ...
      labs(title = paste0("Moyenne des probabilités d'assecs lissées sur 5 jours (1976-2005) - Modèle hydrologique ",str_before_first(nom_categorieSimu_,"_")," - HER ",HER_h_),
           x = "Date",
