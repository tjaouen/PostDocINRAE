...
# print(paste0("Rrank = ",Rrank))
# print("liste_scenarios_[Rrank]")
# print(liste_scenarios_)
# print("liste")
# print(liste)
            ...
            if (dir.exists(sc_)){ #,"/ExtraitAnneesOnde20102023/"
              if (file.exists(paste0(sc_,
                ...
                tryCatch({
                  ...
                  print(paste0("sc : ",sc_, #,"/ExtraitAnneesOnde20102023/"
                               "/FDC_",sub("\\..*", "", Select_hydro[st]),".txt"))
                  ...
                  print(paste0("Erreur : st = ",st," - ","/FDC_",sub("\\..*", "", Select_hydro[st]),".txt"))
