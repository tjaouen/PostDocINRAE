...
print('ORCHIDEE - 3_OndeHydro_MatriceInput_Parallele_JonctionHERcriteresES_10jours_GestionErreurs_FDCmeanJm6Jj_MPI_26_20240209')
...
liste_scenarios_ = list.files(paste0(folder_input_,"FlowDurationCurves_meanJm6Jj/",
                              ...
                              full.names = T)
# liste_scenarios_ = liste_scenarios_[c(1,6)]
# liste_scenarios_ = liste_scenarios_[c(6)]
          ...
          tryCatch({
                    ...
                    for (st in 1:length(Select_hydro)){
                      ...
                      if (dir.exists(sc_)){ #,"/ExtraitAnneesOnde20102023/"
                        ...
                        if (file.exists(paste0(sc_, #,"/ExtraitAnneesOnde20102023/"
                          ...
                          print(paste0("/FDC_",sub("\\..*", "", Select_hydro[st]),".txt"))
            ...
            if (!(dir.exists(paste0(folder_output_,
              ...
              dir.create(paste0(folder_output_,
                                ...
                                # ifelse(nom_GCM_=="","",paste0("/",nom_GCM_)),
                                "/tmp/"))}
            print("output_parAnneeParHer_toutesDates")
            print(output_parAnneeParHer_toutesDates)
            print("file")
            print(paste0(folder_output_,
                         ...
                         ifelse(sc_=="","",paste0("/",basename(sc_))),
                         # ifelse(nom_GCM_=="","",paste0("/",nom_GCM_)),
                         "/tmp/MatInputModel_ByHERDates_2012_2022_",str_replace_all(basename(il), 'Stations_HYDRO_|.csv', ''),"_",obsSim_,"_Weight_",annee,"_HER",i,".csv"))
