...
# nc_evspsblpotAdjust_historical_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J10Jj/evspsblpotAdjust_France_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_19500101-20051231_Hg0175_J10Jj.nc", "r+")
# nc_evspsblpotAdjust_rcp26_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J10Jj/evspsblpotAdjust_France_MPI-M-MPI-ESM-LR_rcp26_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_Hg0175_J10Jj.nc", "r+")
# nc_evspsblpotAdjust_rcp45_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J10Jj/evspsblpotAdjust_France_MPI-M-MPI-ESM-LR_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_Hg0175_J10Jj.nc", "r+")
# nc_evspsblpotAdjust_rcp85_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J10Jj/evspsblpotAdjust_France_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_Hg0175_J10Jj.nc", "r+")

# Chemin de base à explorer
base_dir = "/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J10Jj/"
...
evspsblpotAdjust_JjJ10_26_ = np.copy(evspsblpotAdjust_combined_26_)
n_slices_26_ = evspsblpotAdjust_JjJ10_26_.shape[0]
print("n_slices_26_=",n_slices_26_)
evspsblpotAdjust_JjJ10_45_ = np.copy(evspsblpotAdjust_combined_45_)
n_slices_45_ = evspsblpotAdjust_JjJ10_45_.shape[0]
print("n_slices_45_",n_slices_45_)
evspsblpotAdjust_JjJ10_85_ = np.copy(evspsblpotAdjust_combined_85_)
n_slices_85_ = evspsblpotAdjust_JjJ10_85_.shape[0]
print("n_slices_85_",n_slices_85_)

# Remplir les 10 premières slices avec des NaN
for i in range(10, n_slices_26_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    evspsblpotAdjust_JjJ10_26_[i,:,:] = np.sum(evspsblpotAdjust_combined_26_[(i-10):(i+1),:,:], axis=0)
evspsblpotAdjust_JjJ10_26_[:10, :, :] = np.nan

for i in range(10, n_slices_45_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    evspsblpotAdjust_JjJ10_45_[i,:,:] = np.sum(evspsblpotAdjust_combined_45_[(i-10):(i+1),:,:], axis=0)
evspsblpotAdjust_JjJ10_45_[:10, :, :] = np.nan

for i in range(10, n_slices_85_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    evspsblpotAdjust_JjJ10_85_[i,:,:] = np.sum(evspsblpotAdjust_combined_85_[(i-10):(i+1),:,:], axis=0)
evspsblpotAdjust_JjJ10_85_[:10, :, :] = np.nan


# Séparation des données historiques et rcp26
evspsblpotAdjust_historical_ = evspsblpotAdjust_JjJ10_26_[:evspsblpotAdjust_historical_.shape[0], :, :]
evspsblpotAdjust_rcp26_ = evspsblpotAdjust_JjJ10_26_[evspsblpotAdjust_historical_.shape[0]:, :, :]
evspsblpotAdjust_rcp45_ = evspsblpotAdjust_JjJ10_45_[evspsblpotAdjust_historical_.shape[0]:, :, :]
evspsblpotAdjust_rcp85_ = evspsblpotAdjust_JjJ10_85_[evspsblpotAdjust_historical_.shape[0]:, :, :]
