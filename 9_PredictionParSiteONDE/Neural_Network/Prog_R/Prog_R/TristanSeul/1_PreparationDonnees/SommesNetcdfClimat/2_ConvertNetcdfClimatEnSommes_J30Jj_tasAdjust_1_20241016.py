...
# nc_tasAdjust_historical_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J30Jj/tasAdjust_France_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_19500101-20051231_J30Jj.nc", "r+")
# nc_tasAdjust_rcp26_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J30Jj/tasAdjust_France_MPI-M-MPI-ESM-LR_rcp26_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_J30Jj.nc", "r+")
# nc_tasAdjust_rcp45_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J30Jj/tasAdjust_France_MPI-M-MPI-ESM-LR_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_J30Jj.nc", "r+")
# nc_tasAdjust_rcp85_ = netCDF4.Dataset("/media/tjaouen/Ultra Touch/Backup/Main/Input/Climat/Projections_Explore2/J30Jj/tasAdjust_France_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_MF-ADAMONT-SAFRAN-1980-2011_day_20060101-21001231_J30Jj.nc", "r+")
...
tasAdjust_JjJ30_26_ = np.copy(tasAdjust_combined_26_)
n_slices_26_ = tasAdjust_JjJ30_26_.shape[0]
print("n_slices_26_=",n_slices_26_)
tasAdjust_JjJ30_45_ = np.copy(tasAdjust_combined_45_)
n_slices_45_ = tasAdjust_JjJ30_45_.shape[0]
print("n_slices_45_",n_slices_45_)
tasAdjust_JjJ30_85_ = np.copy(tasAdjust_combined_85_)
n_slices_85_ = tasAdjust_JjJ30_85_.shape[0]
...
for i in range(30, n_slices_26_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    tasAdjust_JjJ30_26_[i,:,:] = np.mean(tasAdjust_combined_26_[(i-30):(i+1),:,:], axis=0)
tasAdjust_JjJ30_26_[:30, :, :] = np.nan

for i in range(30, n_slices_45_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    tasAdjust_JjJ30_45_[i,:,:] = np.mean(tasAdjust_combined_45_[(i-30):(i+1),:,:], axis=0)
tasAdjust_JjJ30_45_[:30, :, :] = np.nan

for i in range(30, n_slices_85_):
    if i % 2500 == 0:
        print(f"Slice i: {i}")
    tasAdjust_JjJ30_85_[i,:,:] = np.mean(tasAdjust_combined_85_[(i-30):(i+1),:,:], axis=0)
tasAdjust_JjJ30_85_[:30, :, :] = np.nan


# Séparation des données historiques et rcp26
tasAdjust_historical_ = tasAdjust_JjJ30_26_[:tasAdjust_historical_.shape[0], :, :]
tasAdjust_rcp26_ = tasAdjust_JjJ30_26_[tasAdjust_historical_.shape[0]:, :, :]
tasAdjust_rcp45_ = tasAdjust_JjJ30_45_[tasAdjust_historical_.shape[0]:, :, :]
tasAdjust_rcp85_ = tasAdjust_JjJ30_85_[tasAdjust_historical_.shape[0]:, :, :]
