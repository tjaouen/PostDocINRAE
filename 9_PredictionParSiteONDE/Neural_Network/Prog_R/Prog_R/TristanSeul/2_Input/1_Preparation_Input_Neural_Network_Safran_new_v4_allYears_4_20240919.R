  ...
  for (HERc in HER2){ #
    ...
    while(id < length(unique(metaData_complet_HER_$Code))){
      ...
      while(n_obs <= length(row_st)){
        ...
        # if (file.exists(paste("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/9_PredictionParSiteONDE/Neural_Network/Data_TJ/Freq_",annee,"_HER_HR/Freq_",annee,"_",HER,"_",indexMaille[index],"_PIEZO_ONLY.txt",sep=""))){
        if (file.exists(paste("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/23_PredictionParSiteONDE_PremierTest/Input/Data/Freq_PiezoOnly/Freq_",annee,"_",HER,"_",indexMaille[index],"_PIEZO_ONLY.txt",sep=""))){
          ...
          # output_HYDRO<-read.table(paste("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/9_PredictionParSiteONDE/Neural_Network/Data_TJ/Freq_",annee,"_HER_HR/Freq_",annee,"_",HER,"_",indexMaille[index],"_PIEZO_ONLY.txt",sep=""),sep=";",header=T)
    ...
    if (ncol(output)>0){
      ...
      # write.table(output,paste("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/23_PredictionParSiteONDE_PremierTest/Input/Data/InputTestClassif/Input_test_classif_HER_",HERc,"_annee",annee,"_30_jours_new_meteo_FINAL.txt", sep=""),sep=";", row.name=F,quote=F)
    }
    ...
    if (ncol(output)>0){
      ...
      # output=read.table(paste("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/23_PredictionParSiteONDE_PremierTest/Input/Data/InputTestClassif/Input_test_classif_HER_",HERc,"_annee",annee,"_30_jours_new_meteo_FINAL.txt", sep=""), header = T, sep = ";", row.names = NULL, quote="")
      ...
      for (i in 1:length(list)){
        ...
        for (id in 1:length(select)){
          ...
          no_flow=which((as.character(output$Mod_ecoulement[select])=="Ecoulement non visible" | as.character(output$Mod_ecoulement[select])=="Assec") & (format(as.Date(output$Date[select],"%Y-%m-%d"),"%m")==format(as.Date(output$Date[select[id]],"%Y-%m-%d"),"%m")))
          flow=which((as.character(output$Mod_ecoulement[select])=="Ecoulement visible" | as.character(output$Mod_ecoulement[select])=="Ecoulement visible acceptable") & (format(as.Date(output$Date[select],"%Y-%m-%d"),"%m")==format(as.Date(output$Date[select[id]],"%Y-%m-%d"),"%m")))
          # print("ok7.5")
      ...
      # write.table(output,paste("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/23_PredictionParSiteONDE_PremierTest/Input/Data/InputTestClassif/Input_test_classif_HER_",HERc,"_annee",annee,"_30_jours_fin_new_meteo_FINAL.txt",sep=""),sep=";", row.name=F,quote=F)
      ...
      #----------------------------------------
      # output <- read.table(paste("/home/tjaouen/Documents/Output/ChangementClimatique2019/EtudeFrance/23_PredictionParSiteONDE_PremierTest/Input/Data/InputTestClassif/Input_test_classif_HER_",HERc,"_annee",annee,"_30_jours_fin_new_meteo_FINAL.txt", sep=""), sep=";", header = T, quote="", stringsAsFactors=F)
      ...
      # write.table(output,paste("/home/tjaouen/Documents/Src/ChangementClimatique_Bottet2019/CodesTristan/9_PredictionParSiteONDE/Neural_Network/Data/Input_Matrice_2017","/Input_test_classif_HER_",HERc,"_annee",annee,"_30_jours_fin_caract_new_meteo_FINAL.txt",sep=""),sep=";", row.name=F,quote=F)
