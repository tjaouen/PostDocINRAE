...
for (HERc in HER[4:43]){
  if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Input_Matrice/Input_test_classif_HER_",HERc,"_30_jours_fin_caract_new_meteo_FINAL.txt",sep=""))==T){
    ...
    if (ncol(data)>0){
      ...
      # On reprend le seuil optimal pour recalculer les scores sur les stations HYDRO
          ...
          if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Var_exp_station_NEW_30J_STATION_HYDRO_NEW/2012_2016/Input_Station_HYDRO_",code_HYDRO,"_HER2_",HERc,".txt",sep=""))){
            if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/QJHYDRO/Export_2018/",code_HYDRO,".txt",sep=""))){
              ...
              if (nrow(data_st)>0){
                ...
                write.table(data_st,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/ANN/J30_FRANCE_2012_2016_station_HYDRO/Output_ANN_station_HYDRO_",code_HYDRO,"_HER2_",HERc,".csv", sep=""), sep=";", row.names = F, col.names = T)
      ...
      write.table(score,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/ANN/Scores_stations_HYDRO/Score_ANN_station_HYDRO_HER2_",HERc,".csv", sep=""), sep=";", row.names = F, col.names = T)
      T2 <- Sys.time()
