    ...
    if(length(unique(donnees[select,127]))==1 & unique(donnees[select,127])==0){
      if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Input_Matrice_2017/Input_test_classif_HER_",HERc,"_30_jours_fin_caract_new_meteo_FINAL.txt",sep=""))){
        ...
        if (nrow(data_st)>0){
          ...
          write.table(data_st,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Random_Forest/J30_FRANCE_2017/Output_RF_",HERc,"_2017.csv", sep=""), sep=";", row.names = F, col.names = T)
...
write.table(critere_full,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Random_Forest/J30_FRANCE_2017/Criteres_RF_PRED_2017.csv", sep=""), sep=";", row.names = F, col.names = T)
