        ...
        for (code_ONDE in liste_st){
          if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Var_exp_station_NEW_30J_ALL/Input_",code_ONDE,".txt",sep=""))){
            ...
            if (nrow(data_st)>0){
              ...
              write.table(data_st,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/LASSO/J30_FRANCE_2012_2016/Output_lasso_",code_ONDE,".csv", sep=""), sep=";", row.names = F, col.names = T)
            }
          } # boucle file exist
        } # boucle station
        T2 <- Sys.time()
