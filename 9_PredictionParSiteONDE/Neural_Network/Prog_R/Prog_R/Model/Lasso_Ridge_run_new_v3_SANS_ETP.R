  ...
  # if (length(test_HER)==0){
    if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Input_Matrice/Input_test_classif_HER_",HERc,"_30_jours_fin_caract_new_meteo_FINAL.txt",sep=""))==T){
      ...
      if (ncol(data)>0){
        ...
        write.table(critere_full,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Graph_critères/Ridge_Lasso_Elastic_net/Résultats_locaux_FRANCE/critere_2012_2016_FULL_moy_j",j,"_new_meteo_all_caract_HER_",HERc,"_SANS_ETP.csv", sep=""), sep=";", row.names = F, col.names = T)
        ...
        write.table(coefficient,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Graph_critères/Ridge_Lasso_Elastic_net/Résultats_locaux_FRANCE/Coefficient_2012_2016_FULL_moy_j",j,"_new_meteo_all_caract_HER_",HERc,"_SANS_ETP.csv", sep=""), sep=";", row.names = F, col.names = T)
