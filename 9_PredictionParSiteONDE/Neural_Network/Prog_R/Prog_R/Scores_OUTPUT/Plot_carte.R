...
variable=c("Prop","NbJ","Diff")
jour="J5"
# data=read.table(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Proportion_assec_",methode,"_",jour,"_new_meteo.csv", sep=""), header = T, sep = ";")
data=read.table(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Proportion_assec_",methode,"_",jour,"_new_meteo.csv", sep=""), header = T, sep = ";")
...
for (v in variable){
  ...
  for (annee in an){
    ...
    if (v=="NbJ"){
      nomFichier <- paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Graph/NbJ_ASSEC_HER97_",methode,"_",jour,"_",annee,"_new_meteo.png",sep="")
      ...
      nomFichier <- paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Graph/Diff_prop_ASSEC_HER97_",methode,"_",jour,"_new_meteo.png",sep="")
      ...
      nomFichier <- paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/OUTPUT/Predictions/Graph/Proportion_ASSEC_2012-2016_HER97_",methode,"_",jour,"_new_meteo.png",sep="")
