...
for (HER in liste) {
  ...
  for (RH in liste_RH){
    ...
    write.table(output,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Freq_1958_2016_HER_HR/Freq_1958_2016_",HER,"_",RH,"_HYDRO_ONLY.txt",sep=""),sep=";", row.name=F,quote=F)
    T2 <- Sys.time()
...
# write.table(NB_Station_HYDRO,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Freq_1958_2016_HER_HR/NB_Station_HYDRO_HER.csv",sep=""),sep=";", row.name=F,quote=F)
