...
# sur les stations HYDRO sélectionnées
#----------------------------------------------------------------------------------------
...
while(id < nrow(liste)){ #nrow(liste)
  ...
  if(length(ligne_hydro)>0){
    ...
    write.table(output,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Var_exp_station_NEW_30J_STATION_HYDRO_NEW/2012_2016/Input_Station_HYDRO_",code_HYDRO,"_HER2_",HER,".txt",sep=""),sep=";", row.name=F,quote=F)
