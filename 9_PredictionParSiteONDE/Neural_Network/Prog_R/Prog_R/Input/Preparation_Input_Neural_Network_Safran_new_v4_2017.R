    ...
    if(HER==HERc){
      ...
      for(annee in 2017){
        ...
        while(n_obs <= length(row_st)){
          ...
          if (file.exists(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Freq_2017_HER_HR/Freq_2017_",HER,"_",RH,"_HYDRO_ONLY.txt",sep=""))==TRUE){
            output_HYDRO<-read.table(paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Freq_2017_HER_HR/Freq_2017_",HER,"_",RH,"_HYDRO_ONLY.txt",sep=""),sep=";",header=T)
