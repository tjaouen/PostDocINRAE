...
# for (HER in 13) {
  ...
  for (RH in liste_RH){
    ...
    # if (nrow(debExtract_full)>0){
      ...
      write.table(output,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Freq_2012_2016_HER_HR/Freq_2012_2016_",HER,"_",RH,"_PIEZO_ONLY.txt",sep=""),sep=";", row.name=F,quote=F)
      T2 <- Sys.time()
