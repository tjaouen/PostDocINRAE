...
nom_data <- paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Liste_station_HER_",HER_select,".csv",sep="")
...
while(id < nrow(hydro)){
  ...
  code_HYDRO<-as.character(hydro[id,2])
  ...
  colnames(output)<-c("Code_HYDRO","Altitude","Date","Mod_ecoulement","AI","REC_HIV",
                      ...
                      "Freq_J","Freq_J-1","Freq_J-2","Freq_J-3","Freq_J-4","Freq_J-5","Freq_J-6","Freq_J-7","Freq_J-8","Freq_J-9","Freq_J-10",'Moy_Freq')
  
  write.table(output,paste("C:/Users/aurelien.beaufort/Documents/Neural_Network/Data/Var_exp_station_NEW_30J_STATION_HYDRO/Input_Station_HYDRO_",code_HYDRO,"_HER2_",HER,"_PIEZO_ONLY.txt",sep=""),sep=";", row.name=F,quote=F)
